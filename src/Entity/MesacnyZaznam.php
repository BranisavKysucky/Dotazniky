...
/**
 * @ORM\Entity(repositoryClass="App\Repository\MesacnyZaznamRepository")
 * @ORM\Table()
 */
class MesacnyZaznam
{
    ...
    /**
     * @ORM\OneToOne(targetEntity="App\Entity\Zamestnanec", mappedBy="mesacny_zaznam", cascade={"persist", "remove"})
     */
    private $zamestnanec;
    ...
    public function setZamestnanec(Zamestnanec $zamestnanec): self
    {
        ...
        if ($this !== $zamestnanec->getMesacnyZaznam()) {
            $zamestnanec->setMesacnyZaznam($this);
        }
